...
class WineStrainsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create wine_strain" do
    assert_difference('WineStrain.count') do
      post wine_strains_url, params: { wine_strain: { strain_id: @wine_strain.strain_id, wine_id: @wine_strain.wine_id } }
    end
  ...
  test "should update wine_strain" do
    patch wine_strain_url(@wine_strain), params: { wine_strain: { strain_id: @wine_strain.strain_id, wine_id: @wine_strain.wine_id } }
